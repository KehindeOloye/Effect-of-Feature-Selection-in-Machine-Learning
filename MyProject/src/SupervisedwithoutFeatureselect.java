...
public class SupervisedwithoutFeatureselect {
    ...
    public void mySupervisedwithoutFeatureselect() throws Exception {
     
    	BufferedReader datafile = readDataFile("theoutput.arff");
